/*
 * $Id: MessageRequester.vm 13524 2008-12-03 10:35:27Z rossmason $
 * --------------------------------------------------------------------------------------
 ...
 */
public class SaajMessageRequester extends AbstractMessageRequester
{

    /* For general guidelines on writing transports see
       http://mule.mulesource.org/display/MULE/Writing+Transports */

    public SaajMessageRequester(InboundEndpoint endpoint)
    {
        super(endpoint);
    }
